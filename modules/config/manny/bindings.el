...
(map! :leader
      ...
      (:when (featurep! :tools upload)
        ...
        (:desc "jump" :prefix "j"
          :desc "go forward"       :n  "j" #'avy-goto-char-2
          :desc "go forward"       :n  "b" #'avy-goto-word-0-above
          :desc "go forward"       :n  "w" #'avy-goto-word-0-below)
      ...
      (:when (featurep! :feature snippets)
        (:desc "snippets" :prefix "s"
          ...
          :desc "go please"             :nv "a" #'counsel-ag-thing-at-point
          :desc "go please"             :nv "A" #'counsel-ag
          :desc "go please"             :nv "s" #'swiper-thing-at-point
          :desc "go please"             :nv "S" #'swiper
